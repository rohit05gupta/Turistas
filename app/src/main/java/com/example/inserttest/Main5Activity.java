...
public class Main5Activity extends ControlActivity implements OnMapReadyCallback,
                ...
                .subscribe(new DisposableSingleObserver<ReverseGeocoderSearchResponse>() {
                    ...
                    private void processResponse(ReverseGeocoderSearchResponse response) {
                        if (response.hasResults()) {
                            ...
                            Toast.makeText(Main5Activity.this, getString(R.string.geocode_no_results), Toast.LENGTH_SHORT).show();
                        }
                    }
    ...
    private void initUIViews() {
        departureIcon = Icon.Factory.fromResources(Main5Activity.this, R.drawable.ic_map_route_departure);
        destinationIcon = Icon.Factory.fromResources(Main5Activity.this, R.drawable.ic_map_route_destination);
    ...
    private void setupUIViewListeners() {
        ...
        btnHelp.setOnClickListener(v -> {
            Intent intent = new Intent(Main5Activity.this, HelpActivity.class);
                        ...
                        .subscribe(new DisposableSingleObserver<AlongRouteSearchResponse>() {
                            ...
                            private void displaySearchResults(List<AlongRouteSearchResult> results) {
                                if (!results.isEmpty()) {
                                    ...
                                    Toast.makeText(Main5Activity.this, String.format(getString(R.string.no_search_results), textToSearch), Toast.LENGTH_LONG).show();
                                }
                            }
    ...
    private void handleApiError(Throwable e) {
        dismissDialogInProgress();
        Toast.makeText(Main5Activity.this, getString(R.string.api_response_error, e.getLocalizedMessage()), Toast.LENGTH_LONG).show();
    }
